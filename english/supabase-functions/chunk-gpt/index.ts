...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const sys = [
      ...
      "",
      "RULES:",
      "1. NEVER make a single function word (the / a / to / of / and /",
      ...
      "3. QUOTED phrases stay together as ONE chunk, INCLUDING the quote",
      "   marks. NEVER split inside quotes.",
      "4. Punctuation tokens (commas, periods, quotes) are NOT separate",
      "   chunks; they belong to the preceding chunk's text but don't",
      "   count toward `indices`.",
      "5. Aim for 5-12 chunks for 15+ word sentences. Don't fragment.",
      "",
      "OUTPUT:",
